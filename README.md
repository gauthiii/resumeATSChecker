...
To run this code, place a doc/docx file in the same directory as thi code and change the file name as follows:

```
resume_file = "<filename>.docs"
# enter the job descriptiobn below like this
job_desc = """
...
<img width="600" alt="Screenshot 2025-01-13 at 12 16 41 AM" src="https://github.com/user-attachments/assets/1be391f0-5641-4649-98ea-99e6566959ac" />
